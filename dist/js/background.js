...
/******/ 	return __webpack_require__(__webpack_require__.s = "./background/background.ts");
/******/ })
/************************************************************************/
/******/ ({
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.RESET = "RESET";
exports.UPDATE_REQUEST_FIELDS = "UPDATE_REQUEST_FIELDS";
exports.UPDATE_REQUEST_ROOT_FIELDS = "UPDATE_REQUEST_ROOT_FIELDS";
exports.updateAddRequestFields = function (payload) {
    return {
        type: exports.UPDATE_REQUEST_FIELDS,
        payload: payload
    };
};
exports.resetAddRequest = function () {
    return {
        type: exports.RESET
    };
};
exports.updateRequestRootFields = function (payload) {
    return {
        type: exports.UPDATE_REQUEST_ROOT_FIELDS,
        payload: payload
    };
};
...
var rootReducer_1 = __webpack_require__(/*! ./../reducers/rootReducer */ "./reducers/rootReducer.ts");
var addRequest_1 = __webpack_require__(/*! ./../reducers/addRequest */ "./reducers/addRequest.ts");
var popup_store_1 = __webpack_require__(/*! ./../store/popup_store */ "./store/popup_store.ts");
exports.store = popup_store_1.default({
    rootReducer: rootReducer_1.INITIAL_POPUP_STATE,
    addRequestReducer: addRequest_1.initialState
});
var actions_1 = __webpack_require__(/*! ./../actions */ "./actions/index.ts");
webext_redux_1.wrapStore(exports.store, {
...
var BackgroundWorker = (function () {
    function BackgroundWorker() {
        ...
        this.startMessageListener = function () {
            chrome.tabs.onUpdated.addListener(function (tabId, changeInfo, tab) {
                if (changeInfo.status === "complete") {
                    chrome.tabs.sendMessage(Number(tab.id), { message: "PAGE_REFRESHED", tabId: tabId });
                }
            });
            chrome.runtime.onMessage.addListener(function (request) {
                ...
                _this.currentTab = request.tabId;
                if (!_this.data[_this.currentTab]) {
                    _this.data[_this.currentTab] = {
                        enabled: false,
                        requests: [],
                        tabId: -1
                    };
                ...
                switch (request.message) {
                    case "ENABLE_LOGGING": {
                        _this.startTrackingRequests(request.tabId);
                        break;
                    }
                    case "DISABLE_LOGGING": {
                        _this.stopTrackingRequests(request.tabId);
                        break;
                    }
                    case "CLEAR_DATA": {
                        _this.clearData(request.tabId);
                        break;
                    }
                    case "UPDATE_BADGE_ICON": {
                        _this.updateBadgeIcon(request.tabId, request.disabledStatus);
                        break;
                    }
                    case "UPDATE_BADGE_TEXT": {
                        _this.updateBadgeText(request.tabId, request.count);
                        break;
                    }
                }
            });
        };
        this.updateBadgeIcon = function (tabId, disabledStatus) {
            var iconBadgeIconPath = disabledStatus ? "images/icon-disabled-16.png" : "images/icon-16.png";
        ...
        this.updateBadgeText = function (tabId, requestsLength) {
            var text = "" + requestsLength;
            chrome.browserAction.setBadgeText({ text: text, tabId: tabId });
        };
        this.callback = function (details) {
            var tabRecords = _this.data[_this.currentTab];
            if (_this.data[_this.currentTab].enabled && _this.currentTab === details.tabId) {
                _this.updateBadgeText(_this.currentTab, tabRecords.requests.length);
                if (tabRecords.requests.filter(function (req) {
                    return req.requestId === details.requestId ||
                        (req.url === details.url && req.method === details.method);
                }).length > 0) {
                    return;
                }
                tabRecords.requests.push(details);
                exports.store.dispatch(actions_1.updateRequest(details.tabId, details));
                _this.updateBadgeText(_this.currentTab, tabRecords.requests.length);
                _this.data[_this.currentTab] = tabRecords;
            }
        };
        this.startTrackingRequests = function (tabId) {
            _this.data[_this.currentTab].enabled = true;
            exports.store.dispatch(actions_1.toggleListeningRequests(tabId, true));
            chrome.webRequest.onBeforeSendHeaders.addListener(_this.callback, {
                urls: ["https://viewerd.kbr.be/display/*/zoomtiles/*/2-*","https://zas.bn.org.pl/image/*/?DeepZoom=*/13/*","https://zas.bn.org.pl/image/*/?DeepZoom=*/14/*"],
                types: ["image"]
            }, ["requestHeaders"]);
        };
        this.stopTrackingRequests = function (tabId) {
            _this.data[_this.currentTab].enabled = false;
            exports.store.dispatch(actions_1.toggleListeningRequests(tabId, false));
        };
        this.clearData = function (tabId) {
            _this.data[_this.currentTab].requests = [];
            _this.updateBadgeText(tabId, 0);
        };
        this.data = {};
    }
...
var addRequest_1 = __webpack_require__(/*! ../actions/addRequest */ "./actions/addRequest.ts");
...
exports.addRequestReducer = function (state, action) {
    if (state === void 0) { state = exports.initialState; }
    switch (action.type) {
        case addRequest_1.UPDATE_REQUEST_FIELDS:
            return __assign(__assign({}, state), { fields: __assign(__assign({}, state.fields), action.payload) });
        case addRequest_1.UPDATE_REQUEST_ROOT_FIELDS:
            return __assign(__assign({}, state), action.payload);
        case addRequest_1.RESET:
            return __assign(__assign({}, exports.initialState), { fields: __assign(__assign({}, exports.initialState.fields), { requestId: uuid().replace(/-/g, "") }) });
        default:
            return state;
    }
};
exports.default = exports.addRequestReducer;
...
Object.defineProperty(exports, "__esModule", { value: true });
var actionType = __webpack_require__(/*! ../actions */ "./actions/index.ts");
exports.INITIAL_POPUP_STATE = {
    tabRecord: {},
    currentUrl: "",
    currentTab: -1,
    showAddRuleModal: false
};
var initialTabProperties = {
    enabledStatus: false,
    requests: [],
    errorMessage: "",
    PageDetails: {
...
function extendTabRecords(state, payload, newTabRecords) {
    var _a;
    return __assign(__assign({}, state), { tabRecord: __assign(__assign({}, state.tabRecord), (_a = {}, _a[payload.tabId] = __assign(__assign({}, state.tabRecord[payload.tabId]), newTabRecords), _a)) });
}
function changeRequestUrl(state, payload) {
    var _a;
    var requests = __spreadArrays(state.tabRecord[payload.tabId].requests);
    requests[payload.index].url = payload.value;
    return __assign(__assign({}, state), { tabRecord: __assign(__assign({}, state.tabRecord), (_a = {}, _a[payload.tabId] = __assign(__assign({}, state.tabRecord[payload.tabId]), { requests: requests }), _a)) });
}
function requestsReducer(state, payload, newRequest) {
    var _a, _b;
    return __assign(__assign({}, state), { tabRecord: __assign(__assign({}, state.tabRecord), (_a = {}, _a[payload.tabId] = __assign(__assign({}, state.tabRecord[payload.tabId]), { requests: __spreadArrays(state.tabRecord[payload.tabId].requests, newRequest), requestRecords: __assign(__assign({}, state.tabRecord[payload.tabId].requestRecords), (_b = {}, _b[payload.request.requestId] = __assign({}, (state.tabRecord[payload.tabId].requestRecords[payload.tabId] ||
                initialRequestProperties)), _b)) }), _a)) });
}
function extendRequestRecords(state, payload, newRequestRecords) {
    var _a, _b;
    return __assign(__assign({}, state), { tabRecord: __assign(__assign({}, state.tabRecord), (_a = {}, _a[payload.tabId] = __assign(__assign({}, state.tabRecord[payload.tabId]), { requestRecords: __assign(__assign({}, state.tabRecord[payload.tabId].requestRecords), (_b = {}, _b[payload.requestId] = __assign(__assign({}, state.tabRecord[payload.tabId].requestRecords[payload.requestId]), newRequestRecords), _b)) }), _a)) });
}
exports.reducer = function (state, action) {
    var _a, _b, _c;
    if (state === void 0) { state = exports.INITIAL_POPUP_STATE; }
    switch (action.type) {
        case actionType.INITIALISE_DEFAULTS:
            return __assign(__assign({}, state), { tabRecord: __assign(__assign({}, state.tabRecord), (_a = {}, _a[action.payload.currentTab] = __assign({}, (state.tabRecord[action.payload.currentTab] || initialTabProperties)), _a)), currentUrl: action.payload.currentUrl, currentTab: action.payload.currentTab, interceptStatus: action.payload.interceptStatus });
        case actionType.TOGGLE_SHOW_ADD_REQUEST: {
            return __assign(__assign({}, state), { showAddRuleModal: action.payload.showAddRuleModal });
        }
        ...
        case actionType.TOGGLE_CHECKBOX:
            return extendTabRecords(state, action.payload, {
                checkedReqs: __assign(__assign({}, state.tabRecord[action.payload.tabId].checkedReqs), (_b = {}, _b[action.payload.reqId] = action.payload.checked, _b))
            });
        ...
        case actionType.PAGINATION_CHANGE:
            return extendTabRecords(state, action.payload, {
                PageDetails: __assign(__assign({}, state.tabRecord[action.payload.tabId].PageDetails), (_c = {}, _c[action.payload.field] = action.payload.value, _c))
            });
        case actionType.UPDATE_MESSAGE: {
            return __assign(__assign({}, state), { interceptStatus: action.payload.message });
        }
...
var actions_1 = __webpack_require__(/*! ./../actions */ "./actions/index.ts");
var fetchDataAlias = function (payload) {
    return function (dispatch) {
        var _a = payload.payload.requestDetails, method = _a.method, url = _a.url, requestId = _a.requestId, requestHeaders = _a.requestHeaders, tabId = _a.tabId;
        var requestHeadersObject = requestHeaders
            ? requestHeaders.reduce(function (accumulatedObj, reqHeaderNameValuePair) {
                if (accumulatedObj === void 0) { accumulatedObj = {}; }
                accumulatedObj[reqHeaderNameValuePair.name] = reqHeaderNameValuePair.value;
                return accumulatedObj;
            }, {})
            : {};
        dispatch(actions_1.fetchingResponse(tabId, requestId, true));
        axios({
            method: method,
            url: url,
            ...
            var stringifiedData = headers["content-type"].includes("json")
                ? JSON.stringify(data, null, 2)
                : data;
            dispatch(actions_1.fetchSuccess("", requestId, tabId));
            dispatch(actions_1.handleRespTextChange(stringifiedData, requestId, tabId));
            dispatch(actions_1.fetchSuccess(stringifiedData, requestId, tabId));
        })
            .catch(function () {
            dispatch(actions_1.fetchFailure("Couldn't connect to server. Check your connection and try again.", requestId, tabId));
        })
            .finally(function () {
            dispatch(actions_1.fetchingResponse(tabId, requestId, false));
        });
    };
};
exports.default = {
...
var aliases_1 = __webpack_require__(/*! ./aliases */ "./store/aliases.ts");
var webext_redux_1 = __webpack_require__(/*! webext-redux */ "../node_modules/webext-redux/lib/index.js");
var rootReducer_1 = __webpack_require__(/*! ./../reducers/rootReducer */ "./reducers/rootReducer.ts");
var addRequest_1 = __webpack_require__(/*! ../reducers/addRequest */ "./reducers/addRequest.ts");
var enhancer;
if (true) {
    ...
    enhancer = redux_1.applyMiddleware(webext_redux_1.alias(aliases_1.default), redux_thunk_1.default, logger);
}
else {}
function default_1(initalState) {
    return redux_1.createStore(redux_1.combineReducers({ rootReducer: rootReducer_1.reducer, addRequestReducer: addRequest_1.addRequestReducer }), initalState, enhancer);
}
